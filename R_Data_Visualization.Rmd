...
install.packages(pkgs="knitr",   repos = "https://www.freestatistics.org/cran/")
install.packages("kableExtra",   repos = "https://www.freestatistics.org/cran/")
```
...
##  T-test
De data moeten in het **long format** staan zoals hieronder weergegeven:
...
De data dient in het **long format** te staan zoals hieronder weergegeven.   
