...
We kunnen dit figuur uitbreiden door er meer *Geometries* aan toe te voegen zoald bijvoorbeel lijnen (*geom_line()*).
Daarnaast zijn de eigenschappen van de verschillende *geoms* individueel aan te passen, zoals bijvoorbeeld kleur een grootte. De volgorde waarin de *geoms* in de code staan is de volgorde waarin ze worden getekend, met de laatste als bovenste laag. In dit figuur zijn bijvoorbeeld de lijnen over de punten heen getekend. Als je de volgorde van *geom_point()* en *geom_line()* omdraait worden de punten over de lijn heen getekend.
```{r, eval=TRUE}
...
src="https://www.youtube.com/embed/uiTc55clwuA">
</iframe> 

Uitleg van de lagen waaruit een figuur is opgebouwd:   
 <iframe width="500" height="300"
src="https://www.youtube.com/embed/PiY9hwOkL8U">
</iframe> 
